...
**Purpose:** Automated documentation of ALL work performed by Walle and specialized agents
...
The Universal Output Capture System (UOCS) is Walle's automatic memory - capturing every feature, bug fix, decision, learning, research, and session through hooks with **zero manual effort**.
...
### 2. Stop Hook
**Triggers:** Main agent (Walle) task completion
...
**Load this documentation when Ruslan says:**
