...
6. **{{AGENT_NAME}} Signature:** Small charcoal (#2D2D2D) bottom right
...
Sign "{{AGENT_NAME}}" as a tiny artist signature in charcoal (#2D2D2D) bottom right corner.
...
- ✅ {{AGENT_NAME}} signature bottom right
