...
**{{USER_NAME}}'s aphorisms as shareable visual quote cards using UL aesthetic.**

Creates **VISUAL APHORISM CARDS** — {{USER_NAME}}'s insights and quotes as shareable square images with massive typography and minimal hand-drawn accents.

---

## Purpose

Visual aphorism cards turn {{USER_NAME}}'s memorable one-liners into shareable social media content. These are **typographic statements with personality** — the quote IS the visual, with subtle editorial accents.

**Use this workflow for:**
- Social media quote cards (LinkedIn, Instagram, X)
- Newsletter pull quotes
- {{USER_NAME}}'s aphorisms as standalone images
...
7. **{{USER_NAME}}'s voice** — Punchy, memorable, thought-provoking
...
**Output:**
```
APHORISM: "[{{USER_NAME}}'s quote in all-caps]"
LENGTH: [X words]
...
- {{AGENT_NAME}} signature: Charcoal (#2D2D2D) small in corner
...
- {{USER_NAME}}'s voice amplified visually
