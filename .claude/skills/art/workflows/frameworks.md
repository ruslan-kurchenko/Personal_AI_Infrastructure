...
Creates **VISUAL FRAMEWORKS** — Ruslan's signature mental models illustrated as memorable diagrams with editorial hand-drawn style.

---

## Purpose

Visual frameworks illustrate mental models, thinking frameworks, and conceptual relationships. These are **Ruslan's signature frameworks** made visual — 2x2 matrices, Venn diagrams, conceptual maps with personality and editorial style.

**Use this workflow for:**
- 2x2 matrices and quadrant models
- Venn diagrams with editorial flair
- Conceptual relationship maps
- "The Ruslan Kurchenko Framework for X"
...
FRAMEWORK NAME: "The [Ruslan's Name] Framework for [Topic]"
...
**Key Principle:**
- This becomes THE reference image people remember for Ruslan's framework
